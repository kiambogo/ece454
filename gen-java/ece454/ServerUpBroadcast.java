...
public class ServerUpBroadcast implements org.apache.thrift.TBase<ServerUpBroadcast, ServerUpBroadcast._Fields>, java.io.Serializable, Cloneable, Comparable<ServerUpBroadcast> {
  ...
  public ServerUpBroadcast setHostname(String hostname) {
    this.hostname = hostname;
    return this;
  }
  ...
  public ServerUpBroadcast setServicePort(int servicePort) {
    this.servicePort = servicePort;
    setServicePortIsSet(true);
    return this;
  }
  ...
  public ServerUpBroadcast setManagementPort(int managementPort) {
    this.managementPort = managementPort;
    setManagementPortIsSet(true);
    return this;
  }
