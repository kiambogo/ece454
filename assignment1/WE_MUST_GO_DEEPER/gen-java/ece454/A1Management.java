...
public class A1Management {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public UpdatedNodeList recv_getUpdatedBEList() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getUpdatedBEList_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public UpdatedNodeList getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getUpdatedBEList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getUpdatedBEList_args, UpdatedNodeList> {
      public getUpdatedBEList() {
        super("getUpdatedBEList");
      }
      ...
      public AsyncMethodCallback<UpdatedNodeList> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<UpdatedNodeList>() { 
          public void onComplete(UpdatedNodeList o) {
            getUpdatedBEList_result result = new getUpdatedBEList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getUpdatedBEList_args args, org.apache.thrift.async.AsyncMethodCallback<UpdatedNodeList> resultHandler) throws TException {
...
;
  ...
  public static class getUpdatedBEList_result implements org.apache.thrift.TBase<getUpdatedBEList_result, getUpdatedBEList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getUpdatedBEList_result>   {
    ...
    public UpdatedNodeList success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, UpdatedNodeList.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getUpdatedBEList_result(getUpdatedBEList_result other) {
      if (other.isSetSuccess()) {
        this.success = new UpdatedNodeList(other.success);
      }
    }
    ...
    public UpdatedNodeList getSuccess() {
      return this.success;
    }

    public getUpdatedBEList_result setSuccess(UpdatedNodeList success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((UpdatedNodeList)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getUpdatedBEList_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new UpdatedNodeList();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
