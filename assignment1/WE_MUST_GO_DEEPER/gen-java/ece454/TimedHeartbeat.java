...
public class TimedHeartbeat implements org.apache.thrift.TBase<TimedHeartbeat, TimedHeartbeat._Fields>, java.io.Serializable, Cloneable, Comparable<TimedHeartbeat> {
  ...
  static {
    schemes.put(StandardScheme.class, new TimedHeartbeatStandardSchemeFactory());
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TimedHeartbeat.class, metaDataMap);
  }
  ...
  public TimedHeartbeat deepCopy() {
    return new TimedHeartbeat(this);
  }
  ...
  public TimedHeartbeat setHeartbeat(Heartbeat heartbeat) {
    this.heartbeat = heartbeat;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TimedHeartbeat)
      return this.equals((TimedHeartbeat)that);
    return false;
  }

  public boolean equals(TimedHeartbeat that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TimedHeartbeat other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TimedHeartbeat(");
    boolean first = true;
  ...
  private static class TimedHeartbeatStandardSchemeFactory implements SchemeFactory {
    public TimedHeartbeatStandardScheme getScheme() {
      return new TimedHeartbeatStandardScheme();
    }
  }

  private static class TimedHeartbeatStandardScheme extends StandardScheme<TimedHeartbeat> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TimedHeartbeat struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TimedHeartbeat struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TimedHeartbeatTupleSchemeFactory implements SchemeFactory {
    public TimedHeartbeatTupleScheme getScheme() {
      return new TimedHeartbeatTupleScheme();
    }
  }

  private static class TimedHeartbeatTupleScheme extends TupleScheme<TimedHeartbeat> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TimedHeartbeat struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TimedHeartbeat struct) throws org.apache.thrift.TException {
